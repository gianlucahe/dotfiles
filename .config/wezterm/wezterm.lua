...
local wallpapers_glob = os.getenv("HOME") .. "/Documents/wallpapers/**"
...
local config = {
	...
	debug_key_events = true, -- Set this to true if you need to debug key events
...
wezterm.on("user-var-changed", function(window, pane, name, value)
	...
	if name == "DIFF_VIEW" then
		...
		if incremental ~= nil then
			...
			overrides.background = {
				w.set_nvim_wallpaper("wallOne.jpeg"),
